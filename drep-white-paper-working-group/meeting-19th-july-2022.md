...
That guarantees that the more voters you add into the mix, the more likely it is to get the opposite. Well outcome specifically, they cite various contractions that they have, were essentially 1000s of voters that have a one half plus epsilon chance of being right. But because there's 1000s of them, on average, it's way more likely that the good outcome will have more votes than the bad outcome.&#x20;
