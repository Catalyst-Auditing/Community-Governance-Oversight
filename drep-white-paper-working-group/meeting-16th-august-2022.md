...
And Philip Lazos is putting together kind of a list Due to review on delegated representation, so I felt like that's the, that's the one that should go first because that's the best kind of guide to the whole thing.&#x20;

And then we have staff who's going in more depth in kind of the analytical side of how you measure power in the systems. And then finally, we'll conclude with Aaron who's doing kind of an application of governance in the process of how you would come to consensus in writing a document. And I think today, I think I'm gonna, since Philips, not here, I'm not going to prioritise that when I think I'm actually going to go in backwards order, we've had in several other meetings gone into quite a bit of depth of the measuring voting power. And I do want to go through more of that today with the reviewers. But just to make sure that we're also giving some kind of similar time and depth to Aaron's work. I'd like to start with that today. So I'm going to skip and then I'm going to show you one other thing is I go through this. So each each chapter now will have a section break. So there's Philips section, and I've added some references to his section. And then there's steps, each of the authors should check now that you have those. So you see the taro button right here should make sure that you have the taro as an add on so that you can add and edit citations, and then check that those get added to the bibliography. And later in the meeting, if people want guidance on that we can I can kind of show some of that. But it does work. I was having trouble with it myself. But I think I just needed a little more patience on my side and going a little bit more carefully. Alright, so we're going to talk about Aaron section. But just to be clear, after his section, there's a references section for the whole thing. It would have been nice to do this by each chapter. But Zotero and Google don't have that capability. So we're just going to keep it as as a kind of global for the whole document reference section. So now, Andrew Fisher is not is not apparently able to join us today. But he did a really deep dive and was quite helpful. Have you had a chance to look at his comments, Aaron?
