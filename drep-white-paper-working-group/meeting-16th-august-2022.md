...
yeah, I also left some comments. But the main thing is that I think maybe they could be chosen some another example, because the readers might be confused, because we take this Cardano government's example, that IO G has three, CF and imune. Go have to, but this is on in the catalyst, these companies and entities, they don't have the same power, like in these examples, I mean, that this can maybe confuse a reader because they might think that I EOG Cardano foundation and a Mergo has the influence and voting power in Catalyst. And they have because they are big ADA holders, both like all three entities. They vote but not like this. So this is like a small comment. And the I think maybe it's possible to take if there will be like some tests running or to take some proposal, which was voted and see how many bullets voted and what if, like, maybe try to prognose What if there would be G reps. And how many do gators would be so to take like this example. Just an idea In this example, it might confuse some people on how the governance happens in the catalyst.
