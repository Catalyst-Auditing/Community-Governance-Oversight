...
**Answer:** As a direct voter you only need to cast one vote to get your full voting reward. \[<mark style="color:red;">**Note:**</mark> <mark style="color:red;"></mark><mark style="color:red;">Is this accurate? See next question - in F10 there are minimum requirements for direct voters to vote on at least 30 proposals and 10 challenge proposals.]</mark> But with a dRep, if they don't cast any vote, do the delegates get the reward? I'm not sure they do.  I think it's just a mechanical rather than a  philosophical rule. But we need to check.\
