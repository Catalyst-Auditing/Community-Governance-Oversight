...
This is a way of measuring the probability that an individual in a voting system has the ability to change the outcome of a decision. And it's a kind of comp combinatorial analysis about how often you are a decisive voter versus someone who's not making it who's not influential in the outcome. And the two extremes of that are, if your probability is zero, that means that you're what's called a dummy vote, and you're not actually influencing any of the decisions. And then the other extreme is if the probability is one, then you're a dictator. And you're actually making the choice for the committee about all of the decisions. There are a lot of other issues as well. And many of you will be digging into them. Let's get started with that by looking at the draft outline that I put together, I'm looking for your input on this. And while sort of putting my own thoughts here, kind of biases it feel free to completely delete the title I put next to your name and, you know, put something more appropriate there. But just to kind of get the thought process and the discussion going, let me go through this quickly. And then let's step back through each one and talk about it a little bit. So I'm Stephan McCurdy, he was worked with me on understanding this paper about bonds off voting power in delegated. Rep. voting systems. And he's also identified some Wolfram tools that are already built to do this measurement. So he's, he's already getting started on this. And then I'm Phil, I had, yours was maybe the most difficult for me to identify a title. So I think you particularly need to work on this. But I made it just very broad. And of course, Phil is the co author of a very important paper, that IO G, published at the beginning of the year on blockchain governance and overviewing, lots of different systems. And then, with yours, Aaron, I kind of build on the work you're doing in forming consensus regarding governance documentation.
